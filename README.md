...
Installing llvm-openmp-recipe
=============================

Installing `llvm-openmp-recipe` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
Updating llvm-openmp-recipe-feedstock
=====================================

If you would like to improve the llvm-openmp-recipe recipe or build a new
...
Note that all branches in the conda-forge/llvm-openmp-recipe-feedstock are
